...
export const ClientProfilePopup: React.FC<PopupProps> = ({
  ...
  return (
    <div className="w-[100vw] h-[100vh] fixed top-0 left-0 z-10 flex justify-center items-center bg-[rgba(0,_0,_0,_0.42)] px-[20px]">
      <div className="w-full lg:w-[764px] 2xl:h-[717px] lg:h-[723px] sm:w-[620px] sm:h-[665px] h-[529px] rounded-[30px] bg-white sm:p-[24px_38px] p-[24px_13px]">
        ...
        <div className="flex justify-center 2xl:mt-[34px] lg:mt-[72px] sm:mt-[38px] mt-[56px]">
          <div className="sm:w-[383px] sm:h-[383px] w-[250px] h-[250px] relative">
            ...
            />
            <div className="select-none gap-[7px] sm:gap-[10px] font-medium sm:w-[90px] sm:h-[32px] text-[#5A7D06] text-[10px] sm:text-[16px] w-[58px] h-[21px] absolute bottom-[16px] sm:bottom-[25px] left-[50%] -translate-x-[50%] bg-[#EEF6DBD9] rounded-[56px] flex justify-center items-center">
        ...
        <div className="flex justify-center mt-[33px] font-medium text-[13px] sm:text-[20px] items-center">
          ...
          />
          <div onClick={() => handleRotation()} className="cursor-pointer w-[15px] h-[15px] sm:w-[24px] sm:h-[24px] ml-[8px]">
            <RotateIcon />
          </div>
        ...
        <div className="flex justify-end 2xl:mt-[96px] lg:mt-[64px] sm:mt-[40px] mt-[43px]">
          ...
          <button className="cursor-pointer w-[150px] h-[42px] rounded-[49px] sm:w-[200px] sm:h-[48px] text-[#18470D] text-[16px] font-medium bg-[#CBEC5E]">
            Save
          </button>
        </div>
      </div>
