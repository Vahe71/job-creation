  ...
  return (
    <div className="flex justify-center gap-x-[53px] lg:justify-between flex-wrap lg:flex-nowrap gap-y-[36px]">
      <div className="flex lg:gap-[30px] sm:gap-[15px] min-w-[331px] gap-[6px]">
        <div className="2xl:w-[263px] 2xl:h-[263px] sm:w-[153px] sm:min-w-[153px] sm:h-[153px] min-w-[137px] h-[137px] relative rounded-full">
          <Image
            ...
            height={263}
          />
          <div onClick={() => setPopupOpened(true)} className="w-[36px] h-[36px] rounded-full border-[#CBEC5E] border-[1px] bg-white flex justify-center items-center absolute lg:bottom-[3px] lg:left-[3px] 2xl:bottom-[21px] 2xl:left-[32px] sm:-bottom-[4px] sm:left-[6px] left-[9px] -bottom-[3px] cursor-pointer">
            <div className="w-[18px] h-[18px]">
              <CameraIcon />
            </div>
          </div>
          <div className="2xl:w-[34px] 2xl:h-[34px] sm:w-[19px] sm:h-[19px] right-[18px] bottom-[6px] w-[17px] h-[17px] rounded-full border-[#CBEC5E] border-[1px] bg-white flex justify-center items-center absolute lg:right-[20px] lg:bottom-[6px] 2xl:bottom-[8px] 2xl:right-[37px] sm:right-[20px] sm:bottom-[6px]">
        ...
        <div className="2xl:pt-[40px] sm:pt-[4px] pt-[13px]">
          ...
          <div className="mt-[16px]">
            <div className="lg:w-[98px] w-[84px] h-[36px] flex gap-[7px] rounded-[64px] border-[1px] border-[#AEB3BC] justify-center items-center">
      ...
      <div className="2xl:pt-[45px] lg:pt-[8px]">
        <div className="flex justify-center lg:justify-end">
          <button className="w-[157px] h-[38px] lg:w-[200px] lg:h-[48px] sm:w-[146px] sm:h-[38px] rounded-[49px] bg-[#CBEC5E] text-[#18470D] text-[16px] cursor-pointer font-medium">
            Profile Settings
          </button>
        </div>
        <div className="flex 2xl:gap-[38px] lg:gap-[16px] gap-[13px] sm:mt-[23px] lg:mt-[60px] mt-[32px]">
          <div className="lg:w-[106px] lg:h-[106px] 2xl:w-[100px] 2xl:h-[100px] w-[90px] h-[90px] rounded-full border-[1px] border-[#AEB3BC] flex justify-center items-center">
