        ...
        return (
          <div key={i} className="flex">
            <div className="flex flex-col items-center cursor-pointer">
              ...
              <span className={` text-[14px] mt-[8px] text-nowrap ${step.active ? ' text-[#414750] font-medium ' :  'text-[#565E69] '}`}>
                Step {step.stepCount}
              </span>
            </div>
            {i !== stepsData.length - 1 && (
              <div className={`w-[26px] lg:w-[38px] h-[2px] mt-[18px] mx-[-3px] lg:mx-[8px] ${step.checked ? ' bg-[#CBEC5E] ' : ' bg-[#EAEAEA] '}`}></div>
            )}
          </div>
        );
      })}
